...
credentials = Credentials.from_service_account_file("C:/Users/DELL/Downloads/MyVirEnv/password generator.json", scopes=scope)
client = gspread.authorize(credentials)
spreadsheet = client.open("password generator2")  # Change to your Google Sheet name
...
# Footer
st.markdown("---")
st.text("Developed by sripradha 🚀")